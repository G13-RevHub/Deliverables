            ...
            <main className="">
                ...
                <form className="w-full flex flex-col space-y-4" onSubmit={handleSubmit}>
                    <div>
                        ...
                        pattern="[a-zA-Z0-9àèéìòóù\s_()]+" placeholder="Sono consentiti solo caratteri alfanumerici, lettere accentate, spazi ed i caratteri '(', ')', ed '_'"
                            value={review_data.title} onChange={e => setReviewData({
                                ...review_data,
                        ...
                        <div className="w-1/2 self-center border border-gray-600 rounded-md ">
                            {review_data.tags.map((tag, idx) => (
                                <div key={idx} className="flex flex-row w-full border-b border-gray-600 pr-2">
                                    ...
                                    <p className="w-full pl-2 text-[#25c430] align-middle flex items-center">#{tag}</p>
                                </div>
                            ))}
                            <div className="flex flex-row items-center w-full pr-2">
                                ...
                                <p className="w-full mr-2"><input className="my-0 py-0 ml-2" type="text"
                                pattern="[a-zA-Z0-9àèéìòóù\s_]+" placeholder="Sono lettere, numeri, spazi ed '_'"
                                value={new_tag} onChange={e => setNewTag(e.target.value)} /></p>
                            </div>
                        </div>
                    </div>
                    <div>
